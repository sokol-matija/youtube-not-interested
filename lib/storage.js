...
const DEFAULT_SETTINGS = {
    ...
    hideWatchStats: false,       // hide our injected views · time-ago pills
    hideNativeWatchInfo: false,  // hide YouTube's own views · upload date line under the title
    hideTeaserCarousel: false,
    hideMiniGuide: false,        // hide collapsed left sidebar (ytd-mini-guide-renderer)
    autoHideMasthead: false,     // home feed: slide top bar up on scroll-down
    cinemaMode: false,           // watch page: hide everything but the video
    claudeModel: 'sonnet',
    autoSummarize: false,        // auto-summarize + read aloud on open
    autoSummarizeSilent: false,  // auto-summarize on open, no read, auto-open the panel
    ...
    focusLockUntil: 0,              // epoch ms: timed FAB lock; focus forced on until then, pw to exit early
};
